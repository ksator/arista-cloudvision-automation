...
uri = '/api/resources/inventory/v1/Device/all'
data = {"partialEqFilter": [{"softwareVersion":"4.27.2F","streamingStatus":"STREAMING_STATUS_ACTIVE"}]}

# help(clnt.get)
result = clnt.post(uri, data=data)
print(result)
