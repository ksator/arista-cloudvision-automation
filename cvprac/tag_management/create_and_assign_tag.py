...
tag_label = "dc_name"
tag_value = "london"
clnt.api.tag_config(element_type, ws_id, tag_label, tag_value)

# Assign a tag to devices
interface_id = ''
devices = ['leaf1', 'leaf2', 'leaf3']
for dev in devices: 
    device_id = get_dev_sn(clnt, dev)
    clnt.api.tag_assignment_config(element_type, ws_id, tag_label, tag_value, device_id, interface_id) 
